...
public class LoginActivity extends Activity {
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            service.loginUsers(mEmailView.getText().toString(), mPasswordView.getText().toString(),
                    new Callback<User>() {
                        @Override
    ...
    public interface QueroTreinarService {
        ...
        @GET ("/user/login")
        void loginUsers(@Query("email") String email, @Query("password") String password, Callback<User> callback);
    }
}
